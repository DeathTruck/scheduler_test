...
def scrapeFacebookPageFeedComments(page_id, access_token):
    filein = '%s_facebook_comments.csv' % page_id
    with open(filein, 'wb') as file:
        ...
        with open('%s_facebook_statuses.csv' % page_id, 'rb') as csvfile:
...
def main_scrape_comments(file_id):
    access_token = "376458226047858|25eba46dbcaf81d225fbfad66f522945"
